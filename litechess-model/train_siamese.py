...
with h5py.File('data/enc_train.h5') as hf:
    train_games = hf["enc_train"][:]

with h5py.File('data/enc_train_labels.h5') as hf:
    train_labels = hf["enc_train_labels"][:]

with h5py.File('data/enc_test.h5') as hf:
    test_games = hf["enc_test"][:]

with h5py.File('data/enc_test_labels.h5') as hf:
    test_labels = hf["enc_test_labels"][:]

train_games_wins = train_games[train_labels == 1]
train_games_losses = train_games[train_labels != 1]

test_games_wins = test_games[test_labels == 1]
test_games_losses = test_games[test_labels != 1]
